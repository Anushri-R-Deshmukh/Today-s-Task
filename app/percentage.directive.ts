...
export class PercentDirective {
  ...
  @Input("greaterThan100") greaterThan100!: boolean;
  ...
  ngOnInit() {
    ...
    const newLocal: any = this.model.valueChanges;
    newLocal.subscribe((value: any) => {
      ...
      if (that.model.control.pristine && value) {
        ...
        const newLocale: any = this.model.valueAccessor;
        newLocale.writeValue(percentStr);
